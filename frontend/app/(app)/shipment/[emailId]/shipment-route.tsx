...
/**
 * The lane as a thumbnail in the page's header: a glance at where the cargo
 * goes, beside the record rather than above it. Absent when either end is not
 * on the map; the record still names both ports.
 */
export function ShipmentRoute({ pol, pod }: { pol: RoutePort | null; pod: RoutePort | null }) {
  ...
  return (
    <figure className="hidden w-[240px] shrink-0 overflow-hidden rounded-md border border-hairline bg-canvas md:block">
