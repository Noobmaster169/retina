...
/** One thing the open page is about, attached to a question. Never a filter. */
...
export const ChatTurn = z.object({
  ...
  /** What the person had attached when they asked. Empty on assistant turns and older turns. */
