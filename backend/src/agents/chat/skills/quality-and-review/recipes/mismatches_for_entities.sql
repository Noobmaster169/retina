...
-- about: The differing fields, with both values, in the emails of one run where any of these things appears.
...
select distinct er.email_id, fd.field, fd.si_value, fd.bl_value, fd.confidence
 ...
 where er.run_id = $2::uuid and not fd.same and not fd.missing
