...
export type Decision =
  ...
  | { action: "join"; kind: EntityKind; entityId: number; surface: string; confidence: number; seen: string };
...
export async function decideSpelling(
  ...
  return {
    decision: { action: "join", kind, entityId: Number(value.sameAs), surface, confidence: value.confidence, seen },
